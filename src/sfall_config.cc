...
bool modConfigInit(int argc, char** argv)
{
    ...
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_AUDIO_CHANNELS_KEY, MOD_CONFIG_DEFAULT_FLOAT_AUDIO_CHANNELS);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_DISTANCE_PER_PERCEPTION_KEY, MOD_CONFIG_DEFAULT_FLOAT_DISTANCE_PER_PERCEPTION);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_OBSTRUCTION_DAMPENING_KEY, MOD_CONFIG_DEFAULT_FLOAT_OBSTRUCTION_DAMPENING);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_EVICTION_POLICY_KEY, MOD_CONFIG_DEFAULT_FLOAT_EVICTION_POLICY);
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_TEXT_SCRAMBLE_KEY, MOD_CONFIG_DEFAULT_FLOAT_TEXT_SCRAMBLE);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_TEXT_SCRAMBLE_DISTANCE_PER_PERCEPTION_KEY, MOD_CONFIG_DEFAULT_FLOAT_TEXT_SCRAMBLE_DISTANCE_PER_PERCEPTION);
    configSetString(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_TEXT_SCRAMBLE_CHARS_KEY, MOD_CONFIG_DEFAULT_FLOAT_TEXT_SCRAMBLE_CHARS);
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_VOICED_FLOATS_KEY, MOD_CONFIG_DEFAULT_VOICED_FLOATS);
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_CENSOR_BLEEP_KEY, MOD_CONFIG_DEFAULT_FLOAT_CENSOR_BLEEP);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_VOLUME_KEY, MOD_CONFIG_DEFAULT_FLOAT_VOLUME);
    ...
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_PIPBOY_AUDIO_KEY, MOD_CONFIG_DEFAULT_PIPBOY_AUDIO);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_PIPBOY_VOLUME_KEY, MOD_CONFIG_DEFAULT_PIPBOY_VOLUME);
