...
bool modConfigInit(int argc, char** argv)
{
    ...
    // simultaneously -- see settings.mod_settings.float_max_count and
    // AUDIO_ENGINE_SOUND_BUFFERS in audio_engine.cc.
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FLOATS_KEY, MOD_CONFIG_FLOAT_MAX_COUNT_KEY, MOD_CONFIG_DEFAULT_FLOAT_MAX_COUNT);
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FLOATS_KEY, MOD_CONFIG_FLOAT_LOGARITHMIC_FALLOFF_KEY, MOD_CONFIG_DEFAULT_FLOAT_LOGARITHMIC_FALLOFF);
