...
typedef enum GameMouseActionMenuItem {
    ...
    GAME_MOUSE_ACTION_MENU_ITEM_SORT_WEIGHT = 16,
    GAME_MOUSE_ACTION_MENU_ITEM_SORT_VALUE = 17,
    GAME_MOUSE_ACTION_MENU_ITEM_SORT_REVERSE = 18,
    GAME_MOUSE_ACTION_MENU_ITEM_COMPANION_INVENTORY = 19,
