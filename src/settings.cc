...
void settingsFromModConfig()
{
    ...
    modSettingsRead(MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_TEXT_SCRAMBLE_DISTANCE_PER_PERCEPTION_KEY, settings.mod_settings.float_text_scramble_distance_per_perception);
