...
#define MOD_CONFIG_WORLDMAP_FOG_LEVEL "FogLevel"
...
#define MOD_CONFIG_DEFAULT_BURST_MOD_CENTER_MULTIPLIER 1
#define MOD_CONFIG_DEFAULT_BURST_MOD_CENTER_DIVISOR 3
#define MOD_CONFIG_DEFAULT_BURST_MOD_TARGET_MULTIPLIER 1
#define MOD_CONFIG_DEFAULT_BURST_MOD_TARGET_DIVISOR 2
