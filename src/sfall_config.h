...
#define MOD_CONFIG_DEFAULT_START_YEAR 2167
#define MOD_CONFIG_DEFAULT_START_MONTH 3
#define MOD_CONFIG_DEFAULT_START_DAY 11
...
#define MOD_CONFIG_DEFAULT_VERSION_STRING "FALLOUT SONORA 1.16.4e"
#define MOD_CONFIG_DEFAULT_WORLDMAP_TRAIL_MARKERS 1
